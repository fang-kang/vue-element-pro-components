...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue-element-pro-components/src/utils'), require('vue-element-pro-components/packages/table'), require('vue-element-pro-components/packages/dialog'), require('vue-element-pro-components/packages/form/src/type'), require('vue-element-pro-components/packages/form'), require('vue-element-pro-components/packages/drawer'), require('vue-element-pro-components/src/directive/clipboard/index.js'), require('src/utils')) :
  typeof define === 'function' && define.amd ? define(['vue-element-pro-components/src/utils', 'vue-element-pro-components/packages/table', 'vue-element-pro-components/packages/dialog', 'vue-element-pro-components/packages/form/src/type', 'vue-element-pro-components/packages/form', 'vue-element-pro-components/packages/drawer', 'vue-element-pro-components/src/directive/clipboard/index.js', 'src/utils'], factory) :
  (global = global || self, global.index = factory(global.utils, global.ElProTable$1, global.ElProDialog$1, global.type, global.ElProForm$1, global.ElProDrawer$1, global.clipboard, global.utils$1));
}(this, function (utils, ElProTable$1, ElProDialog$1, type, ElProForm$1, ElProDrawer$1, clipboard, utils$1) { 'use strict';

  ElProTable$1 = ElProTable$1 && ElProTable$1.hasOwnProperty('default') ? ElProTable$1['default'] : ElProTable$1;
  ElProDialog$1 = ElProDialog$1 && ElProDialog$1.hasOwnProperty('default') ? ElProDialog$1['default'] : ElProDialog$1;
  ElProForm$1 = ElProForm$1 && ElProForm$1.hasOwnProperty('default') ? ElProForm$1['default'] : ElProForm$1;
  ElProDrawer$1 = ElProDrawer$1 && ElProDrawer$1.hasOwnProperty('default') ? ElProDrawer$1['default'] : ElProDrawer$1;
  ...
  */
  ...
  var Quill = /*#__PURE__*/Object.freeze({
    'default': quill$1,
    __moduleExports: quill
  });

  //
  var fontSizeStyle = undefined('attributors/style/size');
  var fontSizeClass = undefined('attributors/class/size');
  fontSizeStyle.whitelist = ['10px', '12px', '14px', '16px', '20px', '24px', '32px', '36px'];
  fontSizeClass.whitelist = ['10px', '12px', '14px', '16px', '20px', '24px', '32px', '36px'];
  var defaultOptions = {
    theme: 'snow',
  ...
  __vue_render__$1._withStripped = true;
    ...
    var QuillEditor = normalizeComponent_1(
  ...
  var script$2 = {
    ...
    components: {
      ...
      ElProTable: ElProTable$1,
      ElProDialog: ElProDialog$1
    },
    model: {
      prop: 'formData',
      event: 'change'
    ...
    computed: {
      ...
      formRules: function formRules() {
        var rules = this.metaData.reduce(function (pre, now) {
          var _ref = now || {},
              required = _ref.required,
              originRules = _ref.rules,
              type = _ref.type,
              label = _ref.label;

          if (required || Array.isArray(originRules)) {
            var _rules = originRules ? _toConsumableArray(originRules) : [];

            if (required && !_rules.some(function (item) {
              return item && item.required;
            })) {
              var preStr = [types.input].includes(type) ? '请输入' : '请选择';

              _rules.push({
                required: true,
                message: "".concat(preStr).concat(label),
                trigger: now.type === types.number ? 'change' : ['blur', 'change']
              });
            }

            return _objectSpread2({}, pre, _defineProperty({}, now.key, _rules));
          }
      ...
      formProcessOptions: function formProcessOptions() {
        var _ref2 = this.formOptions || {},
            _ref2$rules = _ref2.rules,
            rules = _ref2$rules === void 0 ? {} : _ref2$rules,
            rest = _objectWithoutProperties(_ref2, ["rules"]);

        return _objectSpread2({
          labelWidth: '70px'
        }, rest || {}, {
          rules: _objectSpread2({}, this.formRules, {}, rules)
        });
      },
      cmpTypes: function cmpTypes() {
        return types;
      },
      metaData: function metaData() {
        var isCollapse = this.isCollapse,
            showNum = this.showNum,
            isShowAll = this.isShowAll; // 展开收起模式 并且 显示表单数量大于1
    ...
    methods: {
      changeVal: function changeVal(column) {
        if (column.onChange) {
          column.onChange({
            column: column,
      ...
      closedDialog: function closedDialog() {
        var formData = this.$refs.formData;
      ...
      handleOk: function () {
        ...
        regeneratorRuntime.mark(function _callee() {
          var formData, key, checkResult, arr;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  formData = this.$refs.formData;
                  key = this.currentColumn.key;
                  _context.prev = 2;
                  _context.next = 5;
                  return formData.checkRule();
                ...
                case 5:
                  ...
                  if (checkResult) {
                    if (this.modalType === 'add') {
                      arr = _toConsumableArray(this.form[key]);
                      arr.push(_objectSpread2({}, this.subForm, {
                        uid: Date.now()
                      }));
                      this.form[key] = arr;
                    } else {
      ...
      createColumn: function createColumn(column) {
        var tableDataOptions = column.tableDataOptions;
        return tableDataOptions || {};
      },
      handleEdit: function handleEdit(column, row, index) {
      ...
      handleDelete: function handleDelete(tableData, index) {
        utils.removeArrayByIndex(tableData, index);
      },
      // 表格类型 点击打开弹窗
      handleClickBtn: function handleClickBtn(column) {
        this.modalType = 'add';
        this.currentColumn = column;
        this.subFormColumn = column.tableDataOptions;
        this.subForm = {};
       ...
       * @param {*} mode
       */
      createMetaData: function createMetaData(mode) {
        var _this = this;

        var columns = this.columns,
            showNum = this.showNum;
        return Object.keys(columns).filter(function (key) {
          return _this.checkShow(columns[key]);
        }).map(function (key, index) {
          var item = columns[key];
          var _item$label = item.label,
              label = _item$label === void 0 ? key : _item$label,
              _item$span = item.span,
              span = _item$span === void 0 ? 18 : _item$span,
              _item$type = item.type,
              type = _item$type === void 0 ? types.input : _item$type,
              _item$columnOption = item.columnOption,
              columnOption = _item$columnOption === void 0 ? {} : _item$columnOption,
      ...
      getFormItemOptions: function getFormItemOptions(column) {
        var formItemOption = column.formItemOption;
        return _objectSpread2({}, formItemOption);
      },
      getColSpanOptions: function getColSpanOptions(column) {
        var colSpanOption = column.colSpanOption,
            span = column.span;
        return _objectSpread2({
          span: span || 24
        }, colSpanOption || {});
      ...
      getColumnOptions: function getColumnOptions(column) {
        var columnOption = column.columnOption,
            type = column.type,
            label = column.label;
        var processColumnOption = {};
        ...
        if (_typeof(columnOption) === 'object') {
          options = columnOption;
        } else if (typeof columnOption === 'function') {
          options = columnOption() || {};
        }

        return _objectSpread2({}, processColumnOption, {}, options);
      },
      checkShow: function checkShow(column) {
      ...
      getOptions: function getOptions(column) {
        ...
        if (typeof column.options === 'function') {
          options = column.options(_objectSpread2({}, this.formData));
        }

        return options || [];
      },
      checkDefaultValue: function checkDefaultValue() {
        var _this2 = this;

        var columns = this.columns;
        var newForm = cloneDeep(this.form);
        Object.keys(columns).forEach(function (key) {
          var item = columns[key];

          if ([types.checkBox, types.area, types.cascader, types.table].includes(item.type) && !Array.isArray(newForm[key])) {
            newForm[key] = [];
          }

          if (!_this2.checkEmpty(item.defaultValue) && _this2.checkEmpty(newForm[key])) {
      ...
      updateFormData: function updateFormData() {
        ...
        if (!this.debounceUpdate) {
          this.debounceUpdate = debounce(function () {
            if (!isEqual(_this3.formData, _this3.form)) {
              var data = cloneDeep(_this3.formData);
              _this3.form = utils.filterObject(data, function (_, key) {
                return _this3.columns[key] || !['createTime', 'updateTime'].includes(key);
              });

              _this3.checkDefaultValue();
            }
          }, 100, {
            leading: true
          });
      ...
      checkRule: function checkRule() {
        ...
        return new Promise(function (resolve, reject) {
          var ruleForm = _this4.$refs.ruleForm;

          if (ruleForm) {
            ruleForm.validate(function (valid, error) {
              if (valid) {
                resolve(true);
              } else {
  ...
  var __vue_render__$2 = function() {
    ...
    return _c(
      "div",
      { staticClass: "el-pro-form" },
      [
        _vm._t("formBefore", null, { form: _vm.form }),
        _vm._v(" "),
        _c(
          "el-form",
          _vm._g(
            _vm._b(
              {
                ...
                ref: "ruleForm",
                attrs: { "validate-on-rule-change": false, model: _vm.form }
              },
              "el-form",
              _vm.formProcessOptions,
              false
            ),
            _vm.$listeners
          ),
          [
            _vm._t("columnBefore", null, { form: _vm.form }),
            _vm._v(" "),
            _c(
              _vm.isRow ? "el-row" : "fragment",
              { tag: "component", attrs: { gutter: 0 } },
              _vm._l(_vm.metaData, function(column) {
                return _c(
                  ...
                  [
                    _c(
                      _vm.isRow ? "el-col" : "fragment",
                      _vm._b(
                        { tag: "component" },
                        "component",
                        _vm.getColSpanOptions(column),
                        false
                      ),
                      [
                        column.type === _vm.cmpTypes.title
                          ...
                          : column.type === _vm.cmpTypes.table
                          ? [
                              _c(
                                "el-button",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.handleClickBtn(column)
                                    }
                                  }
                                },
                                [
                                  _c("span", [
                                    _vm._v("新增" + _vm._s(column.label))
                                  ])
                                ]
                              ),
                              _vm._v(" "),
                              _c("el-pro-table", {
                                attrs: {
                                  data: _vm.form[column.key],
                                  columns: _vm.createColumn(column),
                          ...
                          : _vm._t(
                              column.key + "-all",
                              [
                                _vm._t("rowBefore", null, { form: _vm.form }),
                                _vm._v(" "),
                                _c(
                                  "el-form-item",
                                  _vm._b(
                                  ...
                                  [
                                    ...
                                    _vm._t(
                                      column.key,
                                      [
                                        column.type === _vm.cmpTypes.input
                                          ? _c(
                                              "el-input",
                                              _vm._b(
                                                {
                                                  ...
                                                  model: {
                                                    ...
                                                    expression: "form[column.key]"
                                                  }
                                                },
                                                "el-input",
                                                _vm.getColumnOptions(column),
                                                false
                                              )
                                            )
                                          : column.type === _vm.cmpTypes.number
                                          ? _c(
                                              "el-input-number",
                                              _vm._b(
                                                {
                                          ...
                                          : column.type === _vm.cmpTypes.select
                                          ? _c(
                                              "el-select",
                                              _vm._b(
                                                {
                                          ...
                                          : column.type === _vm.cmpTypes.check
                                          ? _c(
                                              "el-checkbox",
                                              _vm._b(
                                                {
                                              ...
                                              [
                                                _vm._v(
                                                  "\n                  " +
                                                    _vm._s(column.checkLabel) +
                                                    "\n                "
                                                )
                                              ]
                                            )
                                          : column.type === _vm.cmpTypes.checkBox
                                          ? _c(
                                              "el-checkbox-group",
                                              _vm._b(
                                                {
                                          ...
                                          : column.type === _vm.cmpTypes.radio
                                          ? _c(
                                              "el-radio-group",
                                              _vm._b(
                                                {
                                              ...
                                              _vm._l(
                                                _vm.getOptions(column) || [],
                                                function(item, radioIndex) {
                                                  return _c(
                                                    "el-radio",
                                                    {
                                                      key:
                                                        item.value + radioIndex,
                                                      attrs: {
                                                        disabled: item.disabled,
                                                        label:
                                                          item[
                                          ...
                                          : column.type === _vm.cmpTypes.switch
                                          ? _c(
                                              "el-switch",
                                              _vm._b(
                                                {
                                          ...
                                          : column.type === _vm.cmpTypes.slider
                                          ? _c(
                                              "el-slider",
                                              _vm._b(
                                                {
                                          ...
                                          : column.type === _vm.cmpTypes.color
                                          ? _c(
                                              "el-color-picker",
                                              _vm._b(
                                                {
                                          ...
                                          : column.type === _vm.cmpTypes.cascader
                                          ? _c(
                                              "el-cascader",
                                              _vm._b(
                                                {
                                          ...
                                          : column.type === _vm.cmpTypes.editor
                                          ? _c(
                                              "quill-editor",
                                              _vm._b(
                                                {
            ...
            _vm._v(" "),
            _vm._t("columnAfter", null, { form: _vm.form })
          ],
          2
        ),
        _vm._v(" "),
        _vm._t("formAfter", null, { form: _vm.form }),
        _vm._v(" "),
        _c(
          "el-pro-dialog",
          {
            attrs: {
              title:
                "" +
                (_vm.modalType == "add" ? "新增" : "编辑") +
                _vm.currentColumn.label,
              "dialog-options": _vm.tableDialogOptions
            },
            on: { ok: _vm.handleOk, closed: _vm.closedDialog },
            model: {
              value: _vm.visible,
              callback: function($$v) {
                _vm.visible = $$v;
          ...
          [
            _c("el-pro-form", {
              ref: "formData",
              attrs: {
                columns: _vm.subFormColumn,
                "form-options": _vm.tableFormOptions
              },
              model: {
                value: _vm.subForm,
                callback: function($$v) {
  ...
  __vue_render__$2._withStripped = true;
    ...
    /* scoped */
    var __vue_scope_id__$2 = "data-v-873dc676";
    /* module identifier */
    ...
    var ElProForm = normalizeComponent_1(
  ...
  __vue_render__$3._withStripped = true;
    ...
    /* scoped */
    var __vue_scope_id__$3 = "data-v-34051fd4";
    /* module identifier */
  ...
  var script$4 = {
    ...
    computed: {
      ...
      processBtnStyle: function processBtnStyle() {
        return _objectSpread2({
          ...
          [
            ...
            _c(
              "el-pro-drawer",
              {
                attrs: {
                  title: _vm.title,
                  "drawer-width": _vm.drawerWidth,
                  "drawer-options": _vm.drawerOptions
                },
                model: {
  ...
  __vue_render__$4._withStripped = true;
    ...
    var AdvancedSearchBtn = normalizeComponent_1(
  ...
  var script$5 = {
    ...
    computed: {
      ...
      searchColumn: function searchColumn() {
        if (Object.keys(this.searchColumns).length) {
          return this.searchColumns;
        } else if (this.columns) {
          return utils.filterObject(this.columns, function (column) {
            return column.showInSearch;
          });
        }
  ...
  var __vue_render__$5 = function() {
    ...
    return _c(
      "div",
      { staticClass: "el-pro-search", style: _vm.customStyle },
      [
        _vm._t("col-before"),
        _vm._v(" "),
        _c("el-pro-form", {
            ...
            [
              {
                ...
                fn: function() {
                  return [
                    _vm.$slots.before
                      ? _c("el-form-item", [_vm._t("before")], 2)
                      : _vm._e(),
                    _vm._v(" "),
                    !_vm.noSearch
                      ? _c(
                    ...
                    _vm._v(" "),
                    _vm.$slots.middle
                      ? _c("el-form-item", [_vm._t("middle")], 2)
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.isShowAdvancedBtn
                      ? _c(
                          "el-form-item",
                          [
                            _c(
                              "advanced-search-btn",
                              {
                                attrs: { "drawer-width": 450, title: "高级查询" },
                                model: {
                                  value: _vm.showAdvancedBtn,
                                  callback: function($$v) {
                                    _vm.showAdvancedBtn = $$v;
                                  },
                                  expression: "showAdvancedBtn"
                                }
                              },
                              [
                                _c("el-pro-form", {
                    ...
                    _vm._v(" "),
                    _vm.$slots.after
                      ? _c("el-form-item", [_vm._t("after")], 2)
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.isCollapse
                      ? _c(
  ...
  __vue_render__$5._withStripped = true;
    ...
    /* scoped */
    var __vue_scope_id__$5 = "data-v-33ab786c";
    /* module identifier */
    ...
    var ElProSearch = normalizeComponent_1(
  ...
  __vue_render__$6._withStripped = true;
    ...
    /* scoped */
    var __vue_scope_id__$6 = "data-v-0a2b03a2";
    /* module identifier */
      ...
      [
        _c("el-pro-form", {
          ...
          attrs: {
            "is-row": _vm.isRow,
            columns: _vm.searchColumn,
            "form-options": _vm.formProcessOptions
          },
          model: {
            value: _vm.localQuery,
            callback: function($$v) {
        ...
        _vm.showFooter
          ...
          : _vm._e(),
        _vm._v(" "),
        !_vm.showFooter && _vm.$slots.footer ? _vm._t("footer") : _vm._e()
      ],
      2
    )
  };
  ...
  __vue_render__$8._withStripped = true;
    ...
    /* scoped */
    var __vue_scope_id__$8 = "data-v-69107ac0";
    /* module identifier */
    ...
    var ElProAdvancedSearch = normalizeComponent_1(
  ...
  var components = [ElProDialog, ElProForm, ElProPagination, ElProSearch, ElProTable, ElProAdvancedSearch, ElProDrawer];
  ...
  var index = {
    ...
    utils: utils$1,
    install: install,
    ElProDialog: ElProDialog,
    ElProForm: ElProForm,
    ElProPagination: ElProPagination,
    ElProSearch: ElProSearch,
    ElProTable: ElProTable,
    ElProAdvancedSearch: ElProAdvancedSearch,
    ElProDrawer: ElProDrawer
  };
