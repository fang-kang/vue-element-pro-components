...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('packages/form/src/type'), require('src/utils'), require('src/directive/clipboard/index.js')) :
  typeof define === 'function' && define.amd ? define(['packages/form/src/type', 'src/utils', 'src/directive/clipboard/index.js'], factory) :
  (global = global || self, global.table = factory(global.type, global.utils, global.clipboard));
}(this, function (type, utils, clipboard) { 'use strict';
