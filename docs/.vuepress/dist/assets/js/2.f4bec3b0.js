      ...
      function f(t, e, n) {
        ...
        for (var i = o(e), r = 0; r < t.length; r++)
          if (o(t[r].regularPath) === i)
            return Object.assign({}, t[r], { type: 'page', path: h(t[r].path) })
        return (
      ...
      r('match', function(t, e, n) {
        return [
          ...
          function(t) {
            ...
            var l = i.unicode
            i.lastIndex = 0
            for (var p, f = [], d = 0; null !== (p = h(i, r)); ) {
              var g = o(p[0])
              ;(f[d] = g), '' === g && (i.lastIndex = c(r, s(i.lastIndex), l)), d++
            }
            return 0 === d ? null : f
          }
        ]
        ...
        for (
          var G = function(t, e) {
              var n,
                ...
                v = [],
                m = t
              if (!c && d && g && t.constructor === G) return t
              if (
                ((d || h(w, t)) && ((t = t.source), g && (e = ('flags' in m) ? m.flags : S(m))),
                (t = void 0 === t ? '' : f(t)),
                (e = void 0 === e ? '' : f(e)),
                (m = t),
                C && ('dotAll' in P) && (i = !!e && T(e, 's') > -1) && (e = j(e, /s/g, '')),
                (n = e),
                      ...
                      if ('\\' === (e = E(t, i))) e += E(t, ++i)
                        ...
                        switch (!0) {
                          case '[' === e:
                            ...
                            break
                          case '(' === e:
                            I(N, R(t, i + 1)) && ((i += 2), (u = !0)), (r += e), l++
                            continue
                          case '>' === e && u:
                            if ('' === c || b(s, c)) throw new O('Invalid capture group name')
                            ;(s[c] = !0), (a[a.length] = [c, l]), (u = !1), (c = '')
                            continue
                        }
                      u ? (c += e) : (r += e)
                    }
          ...
          B(M[q++])
        ;(w.constructor = G), (G.prototype = w), v(r, 'RegExp', G)
      }
      _('RegExp')
    },
    524: function(t, e, n) {
        ...
        a(
          ...
          function() {
            var t = s(this),
              e = u(t.source),
              n = t.flags
            return '/' + e + '/' + u(void 0 === n && o(h, t) && !('flags' in h) ? f(t) : n)
          },
          { unsafe: !0 }
        )
    },
        ...
        },
        {
          endsWith: function(t) {
            ...
            var n = arguments.length > 1 ? arguments[1] : void 0,
              i = e.length,
              r = void 0 === n ? i : g(o(n), i),
              a = u(t)
            return f ? f(e, a, r) : d(e, r - a.length, r) === a
          }
        }
      )
    },
    ...
    569: function(t, e, n) {
      ...
      function N(t, e) {
        var n = e.$themeConfig,
          ...
          p = c(r),
          f = O()(p) ? h : p
        return !1 === f ? void 0 : j()(f) ? Object(i.k)(s.pages, f, a.path) : u(r, o)
      }
      function P(t, e, n) {
        var i = []
        !(function t(e, n) {
      ...
      var A = T,
        ...
        H = {
          name: 'Sidebar',
          components: { SidebarLinks: n(543).default, NavLinks: C },
          props: ['items']
        },
        W =
          (n(563),
