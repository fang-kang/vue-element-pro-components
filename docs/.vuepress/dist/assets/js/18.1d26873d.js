        ...
        e = Object(n.a)(
          ...
          function () {
            ...
            return a('ContentSlotsDistributor', { attrs: { 'slot-key': t.$parent.slotKey } }, [
              a('h1', { attrs: { id: '快速上手' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#快速上手' } }, [t._v('#')]),
                t._v(' 快速上手')
              ]),
              t._v(' '),
              a('h2', { attrs: { id: '完整引入' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#完整引入' } }, [t._v('#')]),
                t._v(' 完整引入')
              ]),
              t._v(' '),
              a('div', { staticClass: 'language-js extra-class' }, [
                a('pre', { pre: !0, attrs: { class: 'language-js' } }, [
                  a('code', [
                    ...
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token string' } }, [t._v("'vue'")]),
                    t._v('\n\n'),
                    a('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('import')]),
                    t._v(' ElementUI '),
                    a('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('from')]),
                    ...
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token string' } }, [
                      t._v("'element-ui/lib/theme-chalk/index.css'")
                    ]),
                    t._v('\n\nVue'),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('.')]),
                    a('span', { pre: !0, attrs: { class: 'token function' } }, [t._v('use')]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('(')]),
                    t._v('Element'),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(')')]),
                    t._v('\n\n'),
                    ...
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token string' } }, [
                      t._v("'vue-element-pro-components'")
                    ]),
                    t._v('\n'),
                    a('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('import')]),
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token string' } }, [
                      t._v("'vue-element-pro-components/lib/theme/index.css'")
                    ]),
                    t._v('\n\nVue'),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('.')]),
                    a('span', { pre: !0, attrs: { class: 'token function' } }, [t._v('use')]),
                    ...
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token class-name' } }, [t._v('Vue')]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('(')]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('{')]),
                    t._v('\n  '),
                    ...
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token string' } }, [t._v("'#app'")]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(',')]),
                    t._v('\n  '),
                    ...
                    a('span', { pre: !0, attrs: { class: 'token operator' } }, [t._v(':')]),
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token parameter' } }, [t._v('h')]),
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token operator' } }, [t._v('=>')]),
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token function' } }, [t._v('h')]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('(')]),
                    t._v('App'),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(')')]),
                    t._v('\n'),
              ...
              t._v(' '),
              a('h2', { attrs: { id: '按需引入' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#按需引入' } }, [t._v('#')]),
                t._v(' 按需引入')
              ]),
              t._v(' '),
              a('p', [
                ...
                a(
                  ...
                  [t._v('babel-plugin-import'), a('OutboundLink')],
                  1
                ),
                t._v('，我们可以只引入需要的组件，以达到减小项目体积的目的。')
              ]),
              t._v(' '),
              a('p', [t._v('首先，安装 babel-plugin-import')]),
              t._v(' '),
              a('div', { staticClass: 'language-bash extra-class' }, [
                a('pre', { pre: !0, attrs: { class: 'language-bash' } }, [
                  a('code', [
                    ...
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token function' } }, [t._v('install')]),
                    t._v(' babel-plugin-import -D\n')
                  ])
                ])
              ]),
              ...
              a('div', { staticClass: 'language-js extra-class' }, [
                a('pre', { pre: !0, attrs: { class: 'language-js' } }, [
                  a('code', [
                    ...
                    t._v('\n        '),
                    a('span', { pre: !0, attrs: { class: 'token literal-property property' } }, [
                      t._v('libraryDirectory')
                    ]),
                    a('span', { pre: !0, attrs: { class: 'token operator' } }, [t._v(':')]),
                    t._v(' '),
                    a('span', { pre: !0, attrs: { class: 'token string' } }, [t._v('"lib"')]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(',')]),
                    t._v('\n        '),
                    a('span', { pre: !0, attrs: { class: 'token function-variable function' } }, [
                      t._v('style')
                    ...
                    t._v(' name'),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('.')]),
                    a('span', { pre: !0, attrs: { class: 'token function' } }, [t._v('substring')]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('(')]),
                    ...
                    t._v(' name'),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('.')]),
                    a('span', { pre: !0, attrs: { class: 'token function' } }, [t._v('substr')]),
                    a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('(')]),
                    t._v('libDirIndex '),
                    a('span', { pre: !0, attrs: { class: 'token operator' } }, [t._v('+')]),
                    t._v(' '),
                    ...
                    a('span', { pre: !0, attrs: { class: 'token template-string' } }, [
                      ...
                      a('span', { pre: !0, attrs: { class: 'token string' } }, [t._v('/theme/')]),
                      a('span', { pre: !0, attrs: { class: 'token interpolation' } }, [
                        a(
                          'span',
                          {
                      ...
                      a('span', { pre: !0, attrs: { class: 'token string' } }, [t._v('.css')]),
                      a(
                        'span',
                        { pre: !0, attrs: { class: 'token template-punctuation string' } },
                        [t._v('`')]
              ...
              a('p', [
                t._v('接下来，如果你只希望引入部分组件，比如 '),
                a('code', [t._v('ElProDialog')]),
                t._v('和 '),
                a('code', [t._v('ElProForm')]),
                t._v('，那么需要在'),
                a('code', [t._v('main.js')]),
                t._v(' 中写入以下内容：')
              ]),
              ...
              a('h2', { attrs: { id: '开始使用' } }, [
                a('a', { staticClass: 'header-anchor', attrs: { href: '#开始使用' } }, [t._v('#')]),
                t._v(' 开始使用')
              ]),
              t._v(' '),
              a('p', [t._v('至此，现在就可以编写代码了。各个组件的使用方法请参阅它们各自的文档。')])
            ])
          },
          [],
          !1,
